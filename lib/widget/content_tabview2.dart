...
class ContentTabView2 extends StatefulWidget {
  final int conditionId;//年级
  final int menuId;
  ContentTabView2({Key key, this.conditionId, this.menuId})
      : super(key: key);
  @override
  _ContentTabView2State createState() => _ContentTabView2State();
}

class _ContentTabView2State extends State<ContentTabView2> {
  List<ContentBean2> bookList = List();
  int pageNum = 1;
  ...
  @override
  void didUpdateWidget(ContentTabView2 oldWidget) {
  ...
  _requestData() {
    DioUtils.instance.requestNetwork<ContentBean2>(Method.get, Api.GET_BY_TAB,
        queryParameters: {
